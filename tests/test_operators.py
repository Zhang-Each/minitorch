...
def test_sigmoid(a):
    ...
    * it is  strictly increasing.
    ...
    assert is_close(1.0 - sigmoid(a), sigmoid(-a)) == True
    assert sigmoid(0) == 0.5
    assert sigmoid(a) <= sigmoid(a + 100000)
...
def test_symmetric():
    ...
    None
    # TODO: Implement for Task 0.2.
    assert mul(123, 456) == mul(456, 123)
    assert mul(0.1111, 0.9999) == mul(0.9999, 0.1111)
...
def test_distribute():
    ...
    None
    # TODO: Implement for Task 0.2.
    assert mul(123, add(456, 789)) == mul(123, 456) + mul(123, 789)
...
def test_sum_distribute(ls1, ls2):
    ...
    for i in ls2:
        test_sum += i
    assert is_close(test_sum, sum(ls1) + sum(ls2)) == 1.0
