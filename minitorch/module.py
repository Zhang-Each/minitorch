class Module:
    ...
    def named_parameters(self):
        ...
        """
        # TODO: Implement for Task 0.4.
        res = [(key, self._parameters[key]) for key in self._parameters.keys()]
        for mod in self._modules:
            mod_para = self._modules[mod].named_parameters()
            for para in mod_para:
                res.append((mod + '.' + para[0], para[1]))
        return res
    ...
    def parameters(self):
        ...
        for key in self._modules.keys():
            ...
            parameter_list += self._modules[key].parameters()
